...
(defun consistentp (n counter)
  (if (evenp n)
      (loop for ai from 1 to (1- n) by 2
            always (= (gethash ai counter 0) 2))
      (and (= (gethash 0 counter 0) 1)
           (loop for ai from 2 to (1- n) by 2
                 always (= (gethash ai counter 0) 2)))))

(defun solve (n a)
  (if (consistentp n (counter a))
      (mod-acc * 1 +mod+ (_ 0 (floor n 2)) 2)
      0))
